...
//
// Phase 8 Plan 03 (D-19 ripple): FORECAST_LABEL, NOT_ENOUGH_HISTORY, and PI_LABEL
// constants removed — every consumer (PerAnglerMetric forecast branch, picker
// heatmap tooltip, forecast page sections) was retired with the forecast pipeline.
//
